...
def build_baseline_prompt(question: str, criterion: str) -> str:
  ...
  """
    ...
    Answer 1 if the given criterion is met, otherwise answer 0.
    Criterion:{criterion}
    """
...
def run_baseline(model, posts, criterion, batch_size=4):
    ...
    for post in tqdm(posts, desc="Preparing baseline prompts"):
        prompt = build_baseline_prompt(post, criterion)
